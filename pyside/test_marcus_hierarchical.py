...
class Model(QtCore.QObject):
    data_changed = QtCore.Signal(str)  # uuid
    data_added = QtCore.Signal(str)
    data_removed = QtCore.Signal(str)
    model_reset = QtCore.Signal()
...
class EditorItem(QtGui.QWidget):
    pass


class NewItem(QtGui.QPushButton):
...
class HeaderItem(QtGui.QPushButton):
    pass
...
class View(QtGui.QWidget):
    ...
    def add_list(self, uid):
        ...
        QtGui.QApplication.postEvent(lis, event)
    ...
    def event(self, event):
        ...
        if event.type() == EventType.ModelResetEvent:
            ...
            try:
                ...
                QtGui.QApplication.postEvent(lis, lis_event)
...
class Controller(QtGui.QWidget):
    def __init__(self, path, parent=None):
        ...
        label1 = QtGui.QLabel('View 1')
        label2 = QtGui.QLabel('View 2')
...
if __name__ == '__main__':
    ...
    with open('test_marcus_hierarchical_style.css', 'r') as f:
        style = f.read()
