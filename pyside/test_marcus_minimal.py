...
class DataChangedEvent(QtCore.QEvent):
    ...
    def __init__(self):
        super(DataChangedEvent, self).__init__(createEventType(DataChangedEventType))
...
class SelectedEvent(QtCore.QEvent):
    def __init__(self, name):
        super(SelectedEvent, self).__init__(createEventType(SelectedEventType))
        self.setAccepted(False)
        self.name = name
        ...
        if event.type() == DataChangedEventType:
            ...
            for item in removed:
                for existing in self.children():
                    if not isinstance(existing, QtGui.QWidget):
                        continue
...
class Controller(QtGui.QWidget):
    ...
    def data_changed_event(self):
        ...
        QtGui.QApplication.postEvent(self.view, event)
...
if __name__ == '__main__':
    ...
    c = Controller(r'c:\users\madoodia')
    c.show()
