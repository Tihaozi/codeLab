...
#ifndef _NL_SDK_HY_GRIDMESH_VDB_H
#define _NL_SDK_HY_GRIDMESH_VDB_H
...
namespace nextlimit
{
  ...
  namespace rf_sdk
  {
    ...
    //
    //-----------------------------------------------------------------------------------
    class RF_SDK_EXPORTS_DLL_STATIC HY_Mesh_VDB 
        : public RFNodeType<  nl::rf::fluid_wrapper::GridFluidWrapper_VDB, 
    ...
    private:
      ...
      /// Constructor
      HY_Mesh_VDB( nl::rf::fluid_wrapper::GridFluidWrapper_VDB* nativeObjPtr ) 
        : RFNodeType< nl::rf::fluid_wrapper::GridFluidWrapper_VDB, 
                      nl::rf_sdk::Node_ExpRsc >( nativeObjPtr ) {}

    public:
      /// Destructor
      virtual ~HY_Mesh_VDB( void ) {}
    ...
    public:
      ...
      virtual const NL_UINT64 getType( void ) { return node_type::TYPE_HY_MESH_VDB; }
    ...
    protected:
      ...
      // getSdkType
      virtual sdk_type::SdkType getSdkType( void ) { return sdk_type::GRID_MESH_VDB_TYPE; }
...
#endif // _NL_SDK_HY_GRIDMESH_VDB_H...
