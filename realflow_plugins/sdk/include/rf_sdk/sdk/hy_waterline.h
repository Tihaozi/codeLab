...
#ifndef _NL_SDK_RF_HY_WATERLINE_H
#define _NL_SDK_RF_HY_WATERLINE_H
...
namespace nextlimit
{
  ...
  namespace rf_sdk
  {
    ...
    //
    //-----------------------------------------------------------------------------------
    class RF_SDK_EXPORTS_DLL_STATIC HY_Waterline 
      : public RFNodeType< nl::rf::FS_GridFluidWaterLine3, nl::rf_sdk::Node_ExpRsc >
    {
    ...
    private:
      ...
      /// Constructor
      HY_Waterline( nl::rf::FS_GridFluidWaterLine3* nativeObjPtr ) 
        : RFNodeType< nl::rf::FS_GridFluidWaterLine3, 
                      nl::rf_sdk::Node_ExpRsc >( nativeObjPtr ) {};

    public:
      /// Destructor
      virtual ~HY_Waterline( void ) {};
    ...
    public:
      ...
      virtual const NL_UINT64 getType( void ) { return node_type::TYPE_HY_WATERLINE; };
    ...
    protected:
      ...
      // getSdkType
      virtual sdk_type::SdkType getSdkType( void ) { return sdk_type::HY_WATERLINE_TYPE; };
...
#endif // _NL_SDK_RF_HY_WATERLINE_H...
