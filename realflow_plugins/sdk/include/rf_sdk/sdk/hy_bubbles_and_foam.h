...
#ifndef _NL_SDK_RF_HY_BUBBLES_AND_FOAM_H
#define _NL_SDK_RF_HY_BUBBLES_AND_FOAM_H
...
namespace nextlimit
{
  namespace realflow
  {
    class FS_GridFluidBubblesAndFoam3;
  }
}
...
namespace nextlimit
{
  ...
  namespace rf_sdk
  {
    ...
    //
    //-----------------------------------------------------------------------------------
    class RF_SDK_EXPORTS_DLL_STATIC HY_BubblesAndFoam 
      : public RFNodeType< nl::rf::FS_GridFluidBubblesAndFoam3, nl::rf_sdk::Node_ExpRsc >
    {
    ...
    private:
      ...
      /// Constructor
      HY_BubblesAndFoam( nl::rf::FS_GridFluidBubblesAndFoam3* nativeObjPtr ) 
        : RFNodeType< nl::rf::FS_GridFluidBubblesAndFoam3, 
                      nl::rf_sdk::Node_ExpRsc >( nativeObjPtr ) {};

    public:
      /// Destructor
      virtual ~HY_BubblesAndFoam( void ) {};
    ...
    public:
      ...
      virtual const NL_UINT64 getType( void ) { return node_type::TYPE_HY_BUBBLES_AND_FOAM; };
    ...
    protected:
      ...
      // getSdkType
      virtual sdk_type::SdkType getSdkType( void ) { return sdk_type::HY_BUBBLES_AND_FOAM_TYPE; };
...
#endif // _NL_SDK_RF_HY_BUBBLES_AND_FOAM_H...
