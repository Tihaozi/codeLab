...
#ifndef _NL_SDK_RF_HY_SPLASH_H
#define _NL_SDK_RF_HY_SPLASH_H
...
namespace nextlimit
{
  ...
  namespace rf_sdk
  {
    ...
    //
    //-----------------------------------------------------------------------------------
    class RF_SDK_EXPORTS_DLL_STATIC HY_Splash 
      : public RFNodeType< nl::rf::FS_GridFluidSplash3, nl::rf_sdk::Node_ExpRsc >
    {
    ...
    private:
      ...
      /// Constructor
      HY_Splash( nl::rf::FS_GridFluidSplash3* nativeObjPtr ) 
        : RFNodeType< nl::rf::FS_GridFluidSplash3, 
                      nl::rf_sdk::Node_ExpRsc >( nativeObjPtr ) {};

    public:
      /// Destructor
      virtual ~HY_Splash( void ) {};
    ...
    public:
      ...
      virtual const NL_UINT64 getType( void ) { return node_type::TYPE_HY_SPLASH; };
    ...
    protected:
      ...
      // getSdkType
      virtual sdk_type::SdkType getSdkType( void ) { return sdk_type::HY_SPLASH_TYPE; };
