...
#ifndef _NL_SDK_PARTICLE_MESH_H
#define _NL_SDK_PARTICLE_MESH_H
...
namespace nextlimit
{
  ...
  namespace rf_sdk
  {
    ...
    //
    //-----------------------------------------------------------------------------------
    class RF_SDK_EXPORTS_DLL_STATIC ParticleMesh 
      : public RFNodeType<  nl::rf::fluid_wrapper::ParticleFluidWrapper_RK, 
    ...
    private:
      ...
      /// Constructor
      ParticleMesh( nl::rf::fluid_wrapper::ParticleFluidWrapper_RK* nativeObjPtr ) 
        : RFNodeType< nl::rf::fluid_wrapper::ParticleFluidWrapper_RK, 
                      nl::rf_sdk::Node_ExpRsc >( nativeObjPtr ) {};

    public:
      /// Destructor
      virtual ~ParticleMesh( void ) {};
    ...
    public:
      ...
      /// addEmitter:  
      /// 
      /// Add an Emitter to THIS ParticleMesh
      ///
      /// @param [in] emitterName / Emitter 's name to be added to THIS ParticleMesh
      ...
      /// removeEmitter:  
      /// 
      /// Remove an Emitter from THIS ParticleMesh
      ///
      /// @param [in] emitterName / Emitter 's name to removed from THIS ParticleMesh
      ...
      /// getEmitters:  
      ///
      /// Get Emitters 's names that contribute to create THIS ParticleMesh
      ///
      ...
      /// build:  
      ///
      /// Builds the ParticleMesh
      void build();

      /// getGeometry:  
      ///
      /// Get a Tuple with the < Faces, Vertexes > of THIS ParticleMesh 
      ///
      ...
      virtual const NL_UINT64 getType( void ) { return node_type::TYPE_RENDERKIT_MESH; };
    ...
    protected:
      ...
      { 
        return sdk_type::RENDERKIT_MESH_TYPE; 
      };
