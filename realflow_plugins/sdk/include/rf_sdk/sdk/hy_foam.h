...
#ifndef _NL_SDK_RF_HY_FOAM_H
#define _NL_SDK_RF_HY_FOAM_H
...
namespace nextlimit
{
  ...
  namespace rf_sdk
  {
    ...
    //
    //-----------------------------------------------------------------------------------
    class RF_SDK_EXPORTS_DLL_STATIC HY_Foam 
      : public RFNodeType< nl::rf::FS_GridFluidFoam3, nl::rf_sdk::Node_ExpRsc >
    {
    ...
    private:
      ...
      /// Constructor
      HY_Foam( nl::rf::FS_GridFluidFoam3* nativeObjPtr ) 
        : RFNodeType< nl::rf::FS_GridFluidFoam3, 
                      nl::rf_sdk::Node_ExpRsc >( nativeObjPtr ) {};

    public:
      /// Destructor
      virtual ~HY_Foam( void ) {};
    ...
    public:
      ...
      virtual const NL_UINT64 getType( void ) { return node_type::TYPE_HY_FOAM; };
    ...
    protected:
      ...
      // getSdkType
      virtual sdk_type::SdkType getSdkType( void ) { return sdk_type::HY_FOAM_TYPE; };
