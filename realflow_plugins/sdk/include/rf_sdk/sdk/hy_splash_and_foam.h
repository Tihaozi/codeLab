...
#ifndef _NL_SDK_RF_HY_SPLASH_AND_FOAM_H
#define _NL_SDK_RF_HY_SPLASH_AND_FOAM_H
...
namespace nextlimit
{
  namespace realflow
  {
    class FS_GridFluidSplashAndFoam3;
  }
}
...
namespace nextlimit
{
  ...
  namespace rf_sdk
  {
    ...
    //
    //-----------------------------------------------------------------------------------
    class RF_SDK_EXPORTS_DLL_STATIC HY_SplashAndFoam 
      : public RFNodeType< nl::rf::FS_GridFluidSplashAndFoam3, nl::rf_sdk::Node_ExpRsc >
    {
    ...
    private:
      ...
      /// Constructor
      HY_SplashAndFoam( nl::rf::FS_GridFluidSplashAndFoam3* nativeObjPtr ) 
        : RFNodeType< nl::rf::FS_GridFluidSplashAndFoam3, 
                      nl::rf_sdk::Node_ExpRsc >( nativeObjPtr ) {};

    public:
      /// Destructor
      virtual ~HY_SplashAndFoam( void ) {};
    ...
    public:
      ...
      virtual const NL_UINT64 getType( void ) { return node_type::TYPE_HY_SPLASH_AND_FOAM; };
    ...
    protected:
      ...
      // getSdkType
      virtual sdk_type::SdkType getSdkType( void ) { return sdk_type::HY_SPLASH_AND_FOAM_TYPE; };
...
#endif // _NL_SDK_RF_HY_SPLASH_AND_FOAM_H...
