...
#ifndef _NL_SDK_RF_HY_BUBBLES_H
#define _NL_SDK_RF_HY_BUBBLES_H
...
namespace nextlimit
{
  ...
  namespace rf_sdk
  {
    ...
    //
    //-----------------------------------------------------------------------------------
    class RF_SDK_EXPORTS_DLL_STATIC HY_Bubbles 
      : public RFNodeType< nl::rf::FS_GridFluidBubbles3, nl::rf_sdk::Node_ExpRsc >
    {
    ...
    private:
      ...
      /// Constructor
      HY_Bubbles( nl::rf::FS_GridFluidBubbles3* nativeObjPtr ) 
        : RFNodeType< nl::rf::FS_GridFluidBubbles3, 
                      nl::rf_sdk::Node_ExpRsc >( nativeObjPtr ) {};

    public:
      /// Destructor
      virtual ~HY_Bubbles( void ) {};
    ...
    public:
      ...
      virtual const NL_UINT64 getType( void ) { return node_type::TYPE_HY_BUBBLES; };
    ...
    protected:
      ...
      // getSdkType
      virtual sdk_type::SdkType getSdkType( void ) { return sdk_type::HY_BUBBLES_TYPE; };
