...
#ifndef _NL_SDK_RF_HY_WET_H
#define _NL_SDK_RF_HY_WET_H
...
namespace nextlimit
{
  ...
  namespace rf_sdk
  {
    ...
    //
    //-----------------------------------------------------------------------------------
    class RF_SDK_EXPORTS_DLL_STATIC HY_Wet 
      : public RFNodeType< nl::rf::FS_GridFluidWet3, nl::rf_sdk::Node_ExpRsc >
    {
    ...
    private:
      ...
      /// Constructor
      HY_Wet( nl::rf::FS_GridFluidWet3* nativeObjPtr ) 
        : RFNodeType< nl::rf::FS_GridFluidWet3, 
    ...
    public:
      ...
      virtual const NL_UINT64 getType( void ) { return node_type::TYPE_HY_WET; };
    ...
    protected:
      ...
      // getSdkType
      virtual sdk_type::SdkType getSdkType( void ) { return sdk_type::HY_WET_TYPE; };
