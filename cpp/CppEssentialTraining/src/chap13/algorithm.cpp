...
int main(int argc, char *argv[])
{
	...
	string s1 = "big light in sky slated to apear in east";
	...
	cout << "pop two extra sevens" << endl;
	vs.pop_back();
	vs.pop_back();

	// find
	cout << "find 7 in vi" << endl;
	...
	cout << "vi after all transformation: ";
	for(int i : vi) cout << i << " ";
	cout << endl;
